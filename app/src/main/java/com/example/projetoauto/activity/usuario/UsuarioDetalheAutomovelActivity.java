...
//Cometado por nao ser mais necessario
    /*
    ...
    private void configDados() {
        ...
        // Removendo o formato de moeda e as casas decimais
        double valorDeVenda = automovel.getValorDeVenda();
        String valorDeVendaStr = String.valueOf((int) valorDeVenda) + "M";
        txt_valor_venda.setText(getString(R.string.valor_automovel, valorDeVendaStr));
        ...
        // Alteração: Substituindo "Modelo" por "Velocidade" e adicionando sufixo "KM/h"
        txt_modelo.setText("Velocidade: " + automovel.getModelo() + " KM/h");

        txt_tipo.setText("Tipo: " + automovel.getIdTipo());
        txt_ano.setText("Ano: " + automovel.getAno());

        // Alteração: Substituindo "KM" por "Carga(Kg)" e adicionando sufixo "Kg"
        txt_quilometragem.setText("Carga(Kg): " + automovel.getQuilometragem() + " Kg");
    ...
    public void onClick(View view) {
        ...
        if (FirebaseHelper.getAutenticado()) {
            ...
            switch (view.getId()) {
                ...
                // Comentar o case para o botão removido
            /*
            case R.id.ib_agenda:
            ...
            */
            ...
            alertAutenticacao("Você não está autenticado.");
        }
